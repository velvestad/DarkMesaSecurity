# Source: https://github.com/taliesins/terraform-provider-hyperv
...
# This is added by me 
$pw = Read-Host -Prompt "Enter password for certificate export" -AsSecureString
...
# Replaced this since it fails when the rule already exists.
